...
namespace AlvinSoft.TcpMs {
    ...
    public partial class TcpMsServer {
        ...
        public TcpMsServer(IPAddress ip, ushort port, ServerSettings settings) {
            IP = ip;
            Port = port;
            Settings = settings;
        }
...
#pragma warning restore CS1591
        ...
        public async Task StartAsync() {
            ...
            Clients = new ConcurrentDictionary<byte[], Client>();
        ...
        public async Task BroadcastByteAsync(byte data) {
            ...
            List<Task> tasks = new List<Task>(Clients.Count);
